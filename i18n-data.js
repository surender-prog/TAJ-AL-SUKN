...
window.TAJ_I18N = {
  ...
  cms: {
    ...
    'page-about.leadership.b1': 'ممارِسة معتمدة دولياً للمساج التايلاندي',
    'page-about.leadership.b2': 'حاصلة على شهادة طبية مع 15 عاماً من الخبرة في المستشفيات',
    'page-about.leadership.b3': 'ممارِسة معتمدة دولياً لتقنية أكسس بارز',
    'page-about.leadership.b4': 'أكثر من 5 سنوات من الخبرة في استرخاء الجسم الاحترافي',
    'page-about.leadership.b5': 'ترحّب بالعملاء من جميع الأجناس والأعمار والحالات الجسدية',
    'page-about.leadership.b6': 'تنشّط بلطف عمليات الشفاء الذاتي الطبيعية للجسم',
