...
async function saveMember() {
  ...
  const member = {
    ...
    discount:  ({ Silver: 10, Gold: 15 })[tier.name] || 0,
    balance:   BALANCE[tier.name] || 0,
    comp_balance: ({ Silver: { massages: 2, hammams: 0, foot: 1, guest: 0 }, Gold: { massages: 6, hammams: 1, foot: 2, guest: 1 } })[tier.name] || { massages: 0, hammams: 0, foot: 0, guest: 0 },
    totalSpent: tier.price,
    servicesIncluded: ({ Silver: 6, Gold: 14 })[tier.name] || 0,
    servicesUsed: 0,
    joinedVia: 'Admin',
